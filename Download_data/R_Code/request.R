...
for(i in 1:10)
{
    submitFTPRequest (rdth, friendlyname=paste(rics[i], "minute", sep="-"), instrumentList = rics[i], 
    ...
    submitFTPRequest (rdth, friendlyname=paste(rics[i], "hourly", sep="-"), instrumentList = rics[i], 
                      "2011-01-01", "2014-09-30", "00:00:00", "23:59:59.999", 
                      reqtype="Intraday", mktdepth="0",
